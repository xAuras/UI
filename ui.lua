...
or InsertService:LoadLocalAsset("rbxassetid://12510253637")
...
if syn then
syn.protect_gui(ScreenAsset)
end
    ScreenAsset.Parent = CoreGui --Debug and LocalPlayer:FindFirstChildOfClass("PlayerGui") or CoreGui
...
function Assets.Snowflakes(WindowAsset)
    local ParticleEmitter = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/xAuras/utilities/main/main.lua"))()
